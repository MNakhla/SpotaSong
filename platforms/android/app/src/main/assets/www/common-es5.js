...
/***/ "./src/app/service/spotify.service.ts":
/*!********************************************!*\
  !*** ./src/app/service/spotify.service.ts ***!
  \********************************************/
...
var SpotifyService = /** @class */ (function () {
    function SpotifyService(http) {
        ...
        this.headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
            ...
            Authorization: 
            // tslint:disable-next-line:max-line-length
            'Bearer BQDxcdTaT_D9URpDhPiJMJvzKXJJRPfL9b0OeVsZxjCqXy4zrV1-kkiR3uJjwIK_-VtgJMTd_xDL8bPNUb5EIN_lVCGI442QLevhbHSsqaDD78J9Qqe-a8Hwa6YWybRHxLQVRo0zOCT3XOm4ChnozZFfVJ8CwzBBM_iySwuoohC5sn62kiDML6GMpGKUDQzvpHedxhvjd39Bgufl4JMjQBpPXnJ5ysa7tZzHtv2ph7WMx55zEJYlzIKVSUhqCI_tfzXNrmGf6PH6eQ0SxpMThW2aXjjczAaz'
        });
        this.options = { headers: this.headers };
    }
    SpotifyService.prototype.searchMusic = function (str) {
        this.searchUrl =
            'https://api.spotify.com/v1/recommendations?seed_genres=' + str;
        return this.http
            .get(this.searchUrl, this.options)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (data) { return data; }));
    };
    SpotifyService.prototype.getAllGenres = function () {
        this.searchUrl =
    ...
    SpotifyService.prototype.getGenreImages = function (str) {
        this.searchUrl =
            'https://api.spotify.com/v1/search?q=' + str + '&type=playlist';
        return this.http
            .get(this.searchUrl, this.options)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (data) { return data; }));
    };
