...
var SongsViewComponent = /** @class */ (function () {
    function SongsViewComponent() {
    }
    SongsViewComponent.prototype.ngOnInit = function () { };
...
var SongsPageModule = /** @class */ (function () {
...
var SongsPage = /** @class */ (function () {
    // tslint:disable-next-line: variable-name
    function SongsPage(_spotifyService, route) {
        this._spotifyService = _spotifyService;
        this.route = route;
        this.data = [];
    }
    SongsPage.prototype.ngOnInit = function () {
        var _this = this;
        this.route.queryParams
            .subscribe(function (params) {
            _this.genre = params.g;
        });
        this._spotifyService
            .searchMusic(this.genre)
            .subscribe(function (response) {
            if (response) {
                _this.data = response.tracks;
            }
            else {
                _this.data = [];
            }
    ...
    SongsPage.ctorParameters = function () { return [
